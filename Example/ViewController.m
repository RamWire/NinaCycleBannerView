...
- (void)viewDidLoad {
    ...
    NinaBannerView *bannerView = [[NinaBannerView alloc] initWithFrame:CGRectMake(0, 50, FUll_VIEW_WIDTH, FUll_VIEW_HEIGHT / 3) WithCycleStyle:NinaCycleStyleHorizontal WithBannerSource:NinaBannerStyleOnlyLocalSource WithBannerArray:myLocalArray];
