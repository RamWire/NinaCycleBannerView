...
- (void)viewDidLoad {
    ...
    NinaBannerView *bannerView = [[NinaBannerView alloc] initWithFrame:CGRectMake(0, 0, FUll_VIEW_WIDTH, FUll_VIEW_HEIGHT / 2) WithCycleStyle:NinaCycleStyleVertical WithBannerSource:NinaBannerStyleOnlyWebSource WithBannerArray:myWebArray];
